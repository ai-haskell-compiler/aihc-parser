  ...
  testGroup
    ...
    [ testGroup
        ...
        [ example "value binding" "x = 1",
          ...
          example "prefix tuple constructor pattern" "f ((,) a b) = a",
          example "bare prefix tuple constructor pattern" "f (,) = 1",
          example "unboxed prefix tuple constructor pattern" "f ((# , #) a b) = a",
          ...
          example "prefix tuple type constructor" "type Pair = (,) Int Int",
          example "prefix unboxed tuple type constructor" "type Pair = (# , #) Int Int",
          example "arrow type constructor" "type Fn = (->) Int Int",
          example "list type constructor" "type L = [] Int",
          example "promoted empty list" "type E = '[]",
          example "promoted cons" "type C = '(:)",
          example "promoted tuple constructor" "type P = '(,) Int Bool",
